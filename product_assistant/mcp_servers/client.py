...
async def main():
    client = MultiServerMCPClient({
        "hybrid_search": {   # server name
            "command": "/Users/alampata/Desktop/LLMOPS/ECOMMERCE-PRODUCT-ASSISTANT/prod-assistant/bin/python",
            "args": [
                "/Users/alampata/Desktop/LLMOPS/ECOMMERCE-PRODUCT-ASSISTANT/product_assistant/mcp_servers/product_search_server.py"
            ],  # absolute path
            "transport": "stdio",
        }
    })
