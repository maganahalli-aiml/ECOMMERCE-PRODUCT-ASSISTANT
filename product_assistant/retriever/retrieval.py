...
if __name__=='__main__':
    ...
    retrieved_contexts = [_format_docs(retrieved_docs)] if retrieved_docs else ["No relevant documents found."]

    # This is not an actual output, just for pipeline testing
